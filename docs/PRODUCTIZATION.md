...
| `pnpm run test:coverage`    | Passed 15 test files / 117 tests and all thresholds: 82.15% statements, 80.26% branches, 84.23% functions, and 83.57% lines. The new `suite-diff.ts` reached 88.82% statements, 87.09% branches, 100% functions, and 89.42% lines.                                             |
...
| `pnpm build`                | Passed; client JS was 382.65 kB / 110.65 kB gzip, CSS was 44.96 kB / 8.81 kB gzip, server was 4.2 kB, and all seven dependency-free CLI artifacts built.                                                                                                                       |
| Suite-diff CLI artifact     | `dist/atlas-suite-diff.js` was 36,747 bytes; SHA-256 was `5647e42f7037c132f691ff89e9128604434d619f809b95684409bfbfb4d7eef2`.                                                                                                                                                   |
